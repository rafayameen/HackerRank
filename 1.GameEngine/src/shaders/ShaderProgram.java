...
public abstract class ShaderProgram 
{
	...
	protected void bindAttrib(int vaoIndex, String variableName)
	{
		GL20.glBindAttribLocation(programID, vaoIndex, variableName);
	}
	...
	//functions to load values in uniform variables
